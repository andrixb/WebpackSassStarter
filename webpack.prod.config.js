 ...
 * FOR BUILD YOU MUST CURRENTLY USE:
     npm run build 

 *
 * Add this script in package.json to run this configuration:
   "prod": "npm run clean && NODE_ENV=production webpack -p --config ./webpack.prod.config.js",
